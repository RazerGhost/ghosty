    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50/50 via-purple-50/30 to-pink-50/40 dark:from-background dark:via-purple-950/30 dark:to-pink-950/40">
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="text-center mb-8">
          <Button as="a" className="mb-4" href="/" size="sm" variant="bordered">
            ← Back to Home
          </Button>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
          {listeningStats.map((stat) => (
            <Card
              key={stat.label}
              className="p-4 bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm hover:scale-105 transition-transform"
              shadow="lg"
            >
        ...
        <Card
          className="mt-8 p-6 bg-gradient-to-br from-purple-500 to-pink-600 text-white"
          shadow="lg"
        >
          <CardBody className="text-center">
