        ...
        <div className="relative flex h-dvh flex-col items-center justify-center overflow-hidden bg-background px-6 text-center">
            ...
            {active && (
                <div key={launchId} className="pointer-events-none absolute inset-0">
                    ...
                    {/* Rocket */}
                    <Rocket className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 text-primary drop-shadow-lg animate-crash-slow" size={96} />
                </div>
            )}

            {/* Content */}
            <h1 className="text-7xl font-bold">404</h1>
            <p className="mt-3 text-lg text-foreground/70">Looks like we drifted off course…</p>
