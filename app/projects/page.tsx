        ...
        <div className="min-h-screen bg-gradient-to-br from-gray-50/50 via-primary-50/30 to-secondary-50/40 dark:from-background dark:via-primary-950/30 dark:to-secondary-950/40">
            ...
            <div className="max-w-7xl mx-auto p-3 sm:p-4 lg:p-6">
                ...
                <div className="grid grid-cols-12 gap-3 auto-rows-[120px]">
                    ...
                    <Card shadow="lg" className="col-span-12 lg:col-span-8 row-span-3 p-6 bg-gradient-to-br from-blue-500 to-purple-600 text-white relative overflow-hidden">
                        ...
                        <div className="relative z-10">
                            <div className="flex justify-between items-start mb-4">
                                <Chip size="lg" variant="solid" color="success">Featured</Chip>
                                <Chip size="sm" variant="solid" color="default" className="bg-white/20 text-white">
                                    {projects[0].status}
                                </Chip>
                            </div>

                            <CardBody className="p-0">
                                <h2 className="text-2xl lg:text-3xl font-bold mb-3">{projects[0].title}</h2>
                                ...
                                <div className="flex flex-wrap gap-2 mb-6">
                                    {projects[0].tech.map((tech) => (
                                        <Chip key={tech} size="sm" className="bg-white/20 text-white">
                                            {tech}
                                        </Chip>
                                    ))}
                                </div>
                    ...
                    {/* Project Stats */}
                    <Card shadow="lg" className="col-span-6 lg:col-span-2 row-span-1 p-4 bg-gradient-to-br from-emerald-400 to-teal-500 text-white">
                    ...
                    <Card shadow="lg" className="col-span-6 lg:col-span-2 row-span-1 p-4 bg-gradient-to-br from-orange-400 to-red-500 text-white">
                        <CardBody className="text-center">
                    ...
                    <Card shadow="lg" className="col-span-12 lg:col-span-4 row-span-2 p-4 bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm">
                        <CardHeader>
                            <h3 className="text-lg font-bold">Tech Stack</h3>
                        </CardHeader>
                        <CardBody className="pt-0">
                            <div className="grid grid-cols-2 gap-2">
                                {['PHP', 'WordPress', 'Laravel', 'React', 'JavaScript', 'MySQL'].map((tech) => (
                                    <div key={tech} className="flex items-center gap-2 p-2 rounded-lg bg-gray-50 dark:bg-gray-700">
                    ...
                    {/* All Projects List */}
                    <Card shadow="lg" className="col-span-12 row-span-4 p-6 bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm">
                        <CardHeader>
                    ...
                    {/* Contact CTA */}
                    <Card shadow="lg" className="col-span-12 lg:col-span-6 row-span-2 p-6 bg-gradient-to-br from-purple-500 to-indigo-600 text-white">
                        <CardBody className="text-center">
                    ...
                    {/* Back to Home */}
                    <Card shadow="lg" className="col-span-12 lg:col-span-6 row-span-2 p-6 bg-gradient-to-br from-gray-400 to-gray-600 text-white">
